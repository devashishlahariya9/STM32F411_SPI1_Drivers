...
void DMA_EnableDoubleBufferModePTM(DMA_STREAM_t* _stream, uint32_t* _destAddr1, uint32_t* _destAddr2, uint32_t* _srcAddr, uint8_t _CT);
void DMA_DisableDoubleBufferMode(DMA_STREAM_t* _stream);
